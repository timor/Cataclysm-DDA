...
"pocket_data": [
  {
    ...
    "max_item_length": "0 mm",        // Maximum length of items that can fit in this pocket, by their longest_side.  Default is a slanted rod in a d/h=3/4 cylinder (TODO: formula)
